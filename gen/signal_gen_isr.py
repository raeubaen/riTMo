...
if __name__ == "__main__":
  ...
  # getrandom Egamma dall'istogramma (va convertito in TH1F) di stiffy
  # definisci theta (va fatto scan preliminare per ogni bin Egamma)
  # pt = Egamma*sin(theta)
  # phi = getrandom da -pi a pi
  # gamma = TLorentzVector()
  # gamma.SetPtEtaPhiM(Double_t pt, Double_t eta, Double_t phi, Double_t m)
